...
$(function(){
      $(".animated-intro").typed({
        strings: ["I'm <b>20</b>. I live in <b>Bihar, India</b>. <br> I design and manage websites for <b>1 years</b>. ",
        		  " <b>Everything is designed. Few things are designed well.</b> --Brian Reed, Front-end developer. !",
        		  " <b>Design creates culture. Culture shapes values. Values determine the future.</b> <br> Robert L. Peters,<b>Designer and author</b>"], 			//just wrote what text you want to appear
        typeSpeed: 0,
        backSpeed: 0,
        loop: true,
        startDelay: 1500,
